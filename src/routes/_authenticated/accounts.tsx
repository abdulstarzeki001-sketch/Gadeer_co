...
export const Route = createFileRoute("/_authenticated/accounts")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "صفحة إدارة الحسابات وحفظ الرصيد بشكل دائم في قاعدة البيانات.",
      },
    ],
  }),
    ...
    <div style={{ padding: "1.5rem 1rem 3rem", maxWidth: 960, margin: "0 auto" }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ color: "var(--gh-muted)", marginTop: 8, lineHeight: 1.7 }}>
          هنا يمكنك إنشاء حسابات جديدة وتعديل رصيد الحسابات الحالية وحفظها بشكل دائم في قاعدة
          البيانات.
        </p>
      </div>
              ...
              {accounts.map((account) => (
                ...
                >
                  ...
                  <div style={{ margin: "12px 0", color: "#334155" }}>
                    {account.description || "بدون ملاحظات"}
                  </div>
